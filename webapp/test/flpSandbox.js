		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Article Count Application (Barcode)",
									"targetURL": "#anubhavbarcodearticlecountapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"anubhavbarcodearticlecountapp-display": {
								"semanticObject": "anubhavbarcodearticlecountapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=anubhav.barcode.articlecountapp",
									"url": sap.ui.require.toUrl("anubhav/barcode/articlecountapp")
								}
							}
						}
					}
